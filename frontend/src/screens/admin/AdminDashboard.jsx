    ...
    return (
        <div className="w-full">
            <div className="mb-4 md:mb-6">
                ...
                <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-2">Manage village samooh groups and members</p>
            </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                        {stats.map((stat, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className="bg-white rounded-xl shadow-sm p-4 md:p-6 border-l-4 border-blue-500 hover:shadow-md transition-shadow"
                                >
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 md:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                    <a
                        ...
                        className="p-3 md:p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-center"
                    >
                        <Building2 className="mx-auto mb-2 text-blue-600" size={24} />
                        <p className="text-sm md:text-base font-medium text-gray-700">Group Management</p>
                    ...
                    <a
                        ...
                        className="p-3 md:p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-center"
                    >
                        <Building2 className="mx-auto mb-2 text-gray-400" size={24} />
                        <p className="text-sm md:text-base font-medium text-gray-700">Create New Group</p>
                    </a>
                    <a
                        href="/admin/bank-details"
                        className="p-3 md:p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-center"
                    >
                        <Banknote className="mx-auto mb-2 text-gray-400" size={24} />
                        <p className="text-sm md:text-base font-medium text-gray-700">Add Bank Details</p>
                    </a>
                    <a
                        href="/admin/members"
                        className="p-3 md:p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-center"
